...
if("TRUE" STREQUAL "TRUE")
  set(ekf_SOURCE_PREFIX /home/zc/zcwork/filter/mogo_filter_v1.0/src/mogo_filter)
  set(ekf_DEVEL_PREFIX /home/zc/zcwork/filter/mogo_filter_v1.0/devel)
  set(ekf_INSTALL_PREFIX "")
  set(ekf_PREFIX ${ekf_DEVEL_PREFIX})
else()
  set(ekf_SOURCE_PREFIX "")
  set(ekf_DEVEL_PREFIX "")
  set(ekf_INSTALL_PREFIX /home/zc/zcwork/filter/mogo_filter_v1.0/install)
...
if(NOT "/home/zc/zcwork/filter/mogo_filter_v1.0/src/mogo_filter/include " STREQUAL " ")
  set(ekf_INCLUDE_DIRS "")
  set(_include_dirs "/home/zc/zcwork/filter/mogo_filter_v1.0/src/mogo_filter/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'zc <my@todo.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ekf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zc/zcwork/filter/mogo_filter_v1.0/src/mogo_filter/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zc/zcwork/filter/mogo_filter_v1.0/devel/lib;/opt/ros/noetic/lib)
